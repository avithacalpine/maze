...
class TBT_RewardsReferral_Model_Mysql4_Setup extends Mage_Core_Model_Resource_Setup
{
    ...
    {
        $version = Mage::getConfig()->getNode('modules/TBT_RewardsReferral/version');
        
        $firstInstalledMsgTitle = "Sweet Tooth Referral System v". $version ." was sucessfully installed.";
        $firstInstalledMsgDesc = "Sweet Tooth Referral System v". $version ." was just installed. Remember to clear ALL cache and move template/skin files from base/default to default/default if you are running a version of Magento Community Edition lower than v1.4.";
    ...
    protected function _createSuccessfulUpdateNotice()
    {
        ...
        $msgTitle = "Sweet Tooth Referral System v". $version ." was sucessfully updated.";
        $msgDesc = "Sweet Tooth Referral System v". $version ." was just updated.";
