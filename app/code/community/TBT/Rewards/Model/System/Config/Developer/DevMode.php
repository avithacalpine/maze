...
{
    /**
     * Save the Developer Mode flag to its (custom) config path and set the API URL
     * based on whether or not Developer Mode is enabled
     * @return self
     */
    public function save()
    {
        $defaultApiUrl = $this->getValue() ?
